...
# -*- coding: utf-8 -*-
"""
CLI minimal pour le projet BitPacking.

Comportement :
  - (par défaut) lance BenchRunner (Java) pour générer/mettre à jour results/all_results.csv
...
def main():
    ...
    parser.add_argument("--benchmark", action="store_true", help="lance le benchmark et génère le CSV")
